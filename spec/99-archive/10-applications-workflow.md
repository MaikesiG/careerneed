---
status: archived
superseded_by: ../02-current-product/applications.md and ../01-domain/lifecycle-and-state-transitions.md
reason: Consolidated into current applications workflow and domain lifecycle.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../02-current-product/applications.md](../02-current-product/applications.md).
