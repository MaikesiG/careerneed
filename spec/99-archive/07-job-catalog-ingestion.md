---
status: archived
superseded_by: ../02-current-product/jobs-and-job-sources.md
reason: Consolidated into current jobs and catalog specification.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../02-current-product/jobs-and-job-sources.md](../02-current-product/jobs-and-job-sources.md).
