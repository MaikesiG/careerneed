---
status: archived
superseded_by: ../00-product/roadmap-and-dependencies.md
reason: Replaced by authoritative 6-phase roadmap.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../00-product/roadmap-and-dependencies.md](../00-product/roadmap-and-dependencies.md).
