---
status: archived
superseded_by: ../05-trust-privacy/privacy-ownership-and-export.md and ../06-architecture/system-boundaries-and-integration-principles.md
reason: Split into dedicated trust/privacy standards and architectural boundaries.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../05-trust-privacy/privacy-ownership-and-export.md](../05-trust-privacy/privacy-ownership-and-export.md).
