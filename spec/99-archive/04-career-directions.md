---
status: archived
superseded_by: ../04-future-modules/opportunity-watch-and-routines.md and ../01-domain/domain-model-and-ownership.md
reason: Broad non-technical scope deferred; technical career direction model consolidated.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../04-future-modules/opportunity-watch-and-routines.md](../04-future-modules/opportunity-watch-and-routines.md).
