---
status: archived
superseded_by: ../00-product/target-users-and-jtbd.md and ../00-product/vision-and-principles.md
reason: Consolidated into updated product vision, target personas, and jobs-to-be-done.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../00-product/target-users-and-jtbd.md](../00-product/target-users-and-jtbd.md).
