---
status: archived
superseded_by: ../02-current-product/ (various specs)
reason: Historical status baseline as of 2026-09-17. Current status is maintained per module in 02-current-product/.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../02-current-product/](../02-current-product/).
