---
status: archived
superseded_by: ../06-architecture/notifications-and-alert-policy.md
reason: Multi-channel external push deferred; consolidated into notification and alert policy.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../06-architecture/notifications-and-alert-policy.md](../06-architecture/notifications-and-alert-policy.md).
