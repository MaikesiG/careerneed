---
status: archived
superseded_by: ../02-current-product/interviews-and-preparation.md and ../02-current-product/contacts-follow-ups-and-todos.md
reason: Split into current interviews and contacts/follow-ups/todos specifications.
...
> It is preserved for historical decision context and provenance only. For current authoritative architecture, see [../02-current-product/interviews-and-preparation.md](../02-current-product/interviews-and-preparation.md).
