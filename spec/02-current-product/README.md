...
| **Interview Preparation Brief** | **In progress** | [`../03-ai/interview-preparation-brief.md`](../03-ai/interview-preparation-brief.md) | First controlled AI feature; grounded in JD, round stage, and participants. Backend, UI, and mock tests complete; live quality validation pending. Not production-validated. |
